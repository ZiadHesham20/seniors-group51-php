...
$stat = "SELECT  * ,products.id as proID,products.name as proName,products.image as proImage, categories.name as catName FROM `products` join categories on products.category_id = categories.id";
$result = mysqli_query($con,$stat);
$numOfProducts = mysqli_num_rows($result);

if (isset($_POST['Pid'])) {
  $sql = "INSERT INTO `users_cart`(`product_id`,`user_id`) VALUES ('$_POST[Pid]','$_SESSION[userID]');";
$cartupload = mysqli_query($con,$sql);
}
...
<header>
    ...
    <div class="container">
      <div class="row gy-3 justify-content-between">
        ...
        <div class="order-lg-last col-lg-5 col-sm-8 col-8">
          <div class="d-flex float-end jus align-items-center">
             <?php if(isset($_SESSION['Email']) && ! empty($_SESSION['Email'])):?>
              ...
              <?php else : ?>
                ...
                <a href="./cartPages/addtoCart.php" class="text-primary mx-2"><i class="fas fa-cart-arrow-down fa-2x fa-fw "></i></a> 
  ...
  <div class="bg-primary mb-4">
    <div class="container py-4">
      <h1 class="text-white mt-2">Home</h1>
    </div>
  </div>
  <!-- Heading -->
</header>
    ...
    <div class="row">
              ...
              <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne">
                <div class="accordion-body">
                  <ul class="list-unstyled">
                    <li><a href="./categoriespage.php" class="text-dark">Categories</a></li>
                  </ul>
                </div>
              </div>
            </div>
      ...
      <div class="col-lg-9">
        <header class="d-sm-flex align-items-center border-bottom mb-4 pb-3">
          <strong class="d-block py-2"><?= $numOfProducts ?> Items found </strong>
          <div class="ms-auto">
        ...
        <div class="row align-items-end">
          <?php while($item = mysqli_fetch_assoc($result)): ?>
            ...
            <div class="card  my-2 shadow-2-strong">
              <img src="./upload/product/<?= $item['proImage']?>" class="card-img-top w-100 " style="height: 306px;"/>
              <div class="card-body  ">
                <div class=" flex-row">
                  <h5 class="mb-1 me-1"><?= $item['proName']?></h5>
                </div>
                <div class=" flex-row">
                  <h6 class="mb-1 me-1"><?= $item['price']?> L.E</h6>
                </div>
                <p class="card-text"><?= $item['catName'] ?></p>
                <form method="post">
                <div class="card-footer d-flex align-items-end pt-3 px-0 pb-0 mt-auto">
                  <input type="hidden" name="Pid" value="<?=$item['proID']?>">
                  <button type="submit" class="btn btn-primary shadow-0 me-1">Add to cart</button>
