...
if (isset($_POST['name'])) {
 ...
 $category = $_POST['category_id'];
    ...
    $sql = "INSERT INTO `products`(`name`, `image`, `price`, `color`, `category_id`) VALUES ('$name','$imgname','$price','$color','$category');";
          ...
          <div class="card-body">
            <div class="table-responsive container">
              ...
              <form method="post" enctype="multipart/form-data">
                ...
                <div class="my-2">
                    <label>Color</label>
                <input name="color" type="color" class="form-control w-25">
                </div>
