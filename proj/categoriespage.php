...
<header>
  ...
  <div class="bg-primary mb-4">
    <div class="container py-4">
      <h1 class="text-white mt-2">Categories</h1>
    ...
    <div class="row">
      ...
      <div class="col-lg-9">
        <header class="d-sm-flex align-items-center border-bottom mb-4 pb-3">
          <strong class="d-block py-2">5 Items found </strong>
          <div class="ms-auto">
        ...
        <div class="row align-items-end">
          ...
          <?php while($cat = mysqli_fetch_assoc($result)):?>
            ...
            <a href="./categoryPages/<?= $cat['name']?>productsPage.php">
            <div class="card w-100 my-2 shadow-2-strong">
              <img src="upload/category/<?= $cat['image']?>" class="card-img-top mb-5 w-100" style="height: 306px;" />
              <div class="card-body d-flex justify-content-center align-items-end">
                
                <h2 class="card-text text-center text-black"><?= $cat['name']?></h2>
              </div>
            </div>
            </a>
          </div>
