...
session_start();
include '../config.php';
$sql = "SELECT  * ,products.id as proID,products.name as proName,products.image as proImage, categories.name as catName FROM `products` join categories on products.category_id = categories.id WHERE category_id = '4'";
...
<header>
  ...
  <div class="bg-primary mb-4">
    <div class="container py-4">
      <h1 class="text-white mt-2">Cell Phones</h1>
        ...
        <div class="row align-items-end">
          ...
          <?php while($product = mysqli_fetch_assoc($result)):?>
            ...
            <div class="card  my-2 shadow-2-strong">
              <img src="../upload/product/<?= $product['proImage']?>" class="card-img-top w-100 " style="height: 306px;"/>
              <div class="card-body  ">
                <div class=" flex-row">
                  <h5 class="mb-1 me-1"><?= $product['proName']?></h5>
                </div>
                <div class=" flex-row">
                  <h6 class="mb-1 me-1"><?= $product['price']?> L.E</h6>
                </div>
                <p class="card-text"><?= $product['catName'] ?></p>
                <form method="post">
                <div class="card-footer d-flex align-items-end pt-3 px-0 pb-0 mt-auto">
                  <input type="hidden" name="Pid" value="<?=$product['proID']?>">
