...
session_start();
include '../config.php';
$sql = "SELECT  * ,products.id as proID,products.name as proName,products.image as proImage, categories.name as catName FROM `products` join categories on products.category_id = categories.id WHERE category_id = '5'";
...
<header>
  ...
  <div class="bg-primary mb-4">
    <div class="container py-4">
      <h1 class="text-white mt-2">Furniture</h1>
