...
$stat = "SELECT  * ,products.id as proID,products.name as proName,products.image as proImage, categories.name as catName FROM `products` join categories on products.category_id = categories.id WHERE category_id = '1'";
